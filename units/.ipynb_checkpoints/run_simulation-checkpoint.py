...
print("\n" + "="*80)
print("MASS BALANCE DEBUG")
print("="*80)
print(f"Glucose IN (feed):               {feed_glucose.imass['Glucose']:.2f} kg/hr")
print(f"Glucose OUT (broth):             {broth.imass['Glucose']:.2f} kg/hr")
print(f"Glucose CONSUMED:                {glucose_consumed:.2f} kg/hr")
print(f"\nLactic Acid OUT (product):       {la_production:.2f} kg/hr")
print(f"Biomass OUT (broth):             {broth.imass['WWTsludge']:.2f} kg/hr")
print(f"Ethanol OUT (broth):             {broth.imass['Ethanol']:.2f} kg/hr")
print(f"\nCarbon balance:")
total_products = la_production + broth.imass['WWTsludge'] + broth.imass['Ethanol']
print(f"  Total products:                {total_products:.2f} kg/hr")
print(f"  Glucose consumed:              {glucose_consumed:.2f} kg/hr")
print(f"  Ratio (should be ~1.0):        {total_products/glucose_consumed:.3f}")
print("-"*80)
